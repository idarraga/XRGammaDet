...
RXGDetectorMessenger::RXGDetectorMessenger(RXGDetectorConstruction* Det)
 : G4UImessenger(),
...
RXGDetectorMessenger::~RXGDetectorMessenger()
{
  delete fTargMatCmd;
  delete fChamMatCmd;
  delete fStepMaxCmd;
...
void RXGDetectorMessenger::SetNewValue(G4UIcommand* /*command*/, G4String /*newValue*/)
{
