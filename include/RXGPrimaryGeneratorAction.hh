...
#ifndef RXGPrimaryGeneratorAction_h
#define RXGPrimaryGeneratorAction_h 1
...
class RXGPrimaryGeneratorAction : public G4VUserPrimaryGeneratorAction
{
  public:
    RXGPrimaryGeneratorAction();    
    virtual ~RXGPrimaryGeneratorAction();
