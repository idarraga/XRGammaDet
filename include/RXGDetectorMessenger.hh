...
#ifndef RXGDetectorMessenger_h
#define RXGDetectorMessenger_h 1

#include "globals.hh"
#include "G4UImessenger.hh"

class RXGDetectorConstruction;
class G4UIdirectory;
...
class RXGDetectorMessenger: public G4UImessenger
{
  public:
    RXGDetectorMessenger(RXGDetectorConstruction* );
    virtual ~RXGDetectorMessenger();
    
    virtual void SetNewValue(G4UIcommand*, G4String);
    
  private:
    RXGDetectorConstruction*  fDetectorConstruction;
